...
本博客基于 VitePress 构建，基于 Elog+Notion 进行即时写作。
...
从 2020 年开始就想写一个记录自己写代码时候遇到问题能够记录下来的博客平台，经过这几年的无数次尝试，终于还是在今年 2024 年更换成了非常简单和便捷的 VitePress。
...
VitePress 的文档模式我觉得还是更好一点的，左侧边栏的类文件夹目录使得更方便阅读和查看，比写了不看或者很难找到之前写的东西的之前的状态要好很多。
...
基于这个在 2024 年优秀的笔记分离架构，我可以很好的更换博客的前端。这一次我找到了 Elog 这个中介工具，有了它可以连接 Notion 和博客框架。于是这个博客就再一次焕新了。
...
YisuX2.0 是 YisuX.com 的自定义版本。彻底手动重构了 VitePress 的默认样式。样式上借鉴了 Naver 的设计色，内容排版借鉴的 Claude 的设计。整体更加整洁了，初版完结撒花 🎉。并且是使用 TRAE 的第一次辅助编码，主要使用它做代码补全加小功能的功能代码编写，使 2.0 效率地短时间写完了。
