...
7. 最近写vue项目的时候，解构一直是习惯丢响应式，没想到已经支持响应式解构了`（vue3.5+）`，给要是老点的村通网的AI都能懵逼了这个新特性。from:[https://cn.vuejs.org/guide/typescript/composition-api.html#typing-component-props](https://cn.vuejs.org/guide/typescript/composition-api.html#typing-component-props)
