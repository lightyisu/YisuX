...
7. 最近写vue项目的时候，解构一直是习惯丢响应式，没想到已经支持响应式解构了`（vue3.5+）`，给要是老点的村通网的AI都能懵逼了这个新特性一直说这样不行，vue属实小版本也会改这种东西很难受（都是深入人心的vue3面经了）我想不通yyx是怎么想的。虽然不影响写但是额。from:[https://cn.vuejs.org/guide/typescript/composition-api.html#typing-component-props](https://cn.vuejs.org/guide/typescript/composition-api.html#typing-component-props)
