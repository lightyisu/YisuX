...
vibe coding的时候我在想如果项目足够大，我去提示改一个功能，这个功能必定关联另一个地方，而我没有任何关于另一个地方的提示，这个时候就很难办了。应该是很容易导致项目直接报错打不开的，因为在我的小项目的时候我发现要么就不去改，只有你再让他继续改他再会去动。
