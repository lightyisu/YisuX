...
const __pageData = JSON.parse('{"title":"SSL和TLS的关系","description":"","frontmatter":{"catalog":["jishu"],"date":"2023-08-23 08:00:00","type":"Post","slug":"relofTLSandSSL","title":"SSL和TLS的关系","status":"已发布","urlname":"77da3939-fdb4-465f-9abb-c8ef1b8779f3","updated":"2025-08-05 19:25:00"},"headers":[],"relativePath":"jishu/SSL和TLS的关系.md","filePath":"jishu/SSL和TLS的关系.md"}');
const _sfc_main = { name: "jishu/SSL和TLS的关系.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("jishu/SSL和TLS的关系.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const SSL_TLS___ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  SSL_TLS___ as default
};
