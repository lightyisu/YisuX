...
const __pageData = JSON.parse('{"title":"Opera浏览器关闭代理不能上网的问题","description":"","frontmatter":{"catalog":["jishu"],"date":"2023-08-16 08:00:00","type":"Post","slug":"opera_1","title":"Opera浏览器关闭代理不能上网的问题","status":"已发布","urlname":"041350c8-c2c1-4805-8389-e426d0bcda1b","updated":"2025-08-05 19:25:00"},"headers":[],"relativePath":"jishu/Opera浏览器关闭代理不能上网的问题.md","filePath":"jishu/Opera浏览器关闭代理不能上网的问题.md"}');
const _sfc_main = { name: "jishu/Opera浏览器关闭代理不能上网的问题.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("jishu/Opera浏览器关闭代理不能上网的问题.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Opera______________ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  Opera______________ as default
};
